...
async def start(c, m):
    ...
    # start text
    text = f"""Hᴏʟᴀ *{m.from_user.mention(style='md')}*,
I ᴀᴍ Sᴛʏʟɪsʜ Tᴇxᴛ ʙᴏᴛ 
➪Jᴜsᴛ sᴇɴᴅ ᴍᴇ sᴏᴍᴇ ᴛᴇxᴛ ᴀɴᴅ ᴍᴀɢɪᴄ 
┏━━━━━━━━━━━━━━━━━━
┃Fᴏʀ ᴀɴʏ ǫᴜᴇʀʏ [Aᴘᴘᴇᴀʟ](t.me/trainer_zone) ʜᴇʀᴇ
┃Oʀ ᴍʏ [Mᴀsᴛᴇʀ](t.me/Aryanjawale)
┗━━━━━━━━━━━━━━━━━━
➪Pᴏᴡᴇʀᴇᴅ ʙʏ [🦄Pᴇɢᴀsᴜs Nᴇᴛᴡᴏʀᴋ](t.me/PegasusXteam)
"""
